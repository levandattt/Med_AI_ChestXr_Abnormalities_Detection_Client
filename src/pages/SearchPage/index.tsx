...
const SearchPage: React.FC = () => {
    ...
    const handleUpload = () => {
        console.log("Tệp DICOM được chọn:", files);
    }
    ...
    return (
        ...
        <div className="bg-zinc-800 min-h-dvh pt-10">
            <div className={`flex justify-center items-center w-full absolute top-0 bottom-0  ${isFileClose ? "hidden" : "block"}`}>
                <div className={`flex flex-col items-center relative bg-zinc-800 px-10 py-14 rounded  `}>
                    <button
                    ...
                    {
                        files.length > 0 && (
                        <div className="flex flex-col items-center bg-gray-700 p-4 rounded shadow">
                    ...
                    <button
                        className={`bg-zinc-700 text-white px-4 py-2 rounded mt-4`}
